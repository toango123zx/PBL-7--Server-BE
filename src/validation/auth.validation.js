...
const userSchema = Joi.object({
    ...
    dateOfBirth: Joi.date()
        ...
        .messages({
            "date.base": "dateOfBirth must be a valid date (maybe string format yy-mm-dd)",
...
export const checkDuplicateUser = async (req, res, next) => {
    const __user = await userService.getUser(undefined, req.body.username.replace(/\s/g, ''), req.body.email.replace(/\s/g, ''));
