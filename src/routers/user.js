...
// // import * as imageValidation from '../validation/imageValidation';
...
// // userRouter.patch('/avatar', authMiddleware.verifyToken, upload.single('image'), imageValidation.imageValidation, userController.updateUserImage);
